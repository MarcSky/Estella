...
( function() {
	...
	var template = '<img alt="" src="" />',
		templateBlock = new CKEDITOR.template(
			'<figure class="{captionedClass}">' +
				template +
				'<figcaption class="photo_name">{captionPlaceholder}</figcaption>' +
				'<h3 class="photo_autor">Автор</h3>' +
			'</figure>' ),
	...
	CKEDITOR.plugins.add( 'image2', {
		...
		init: function( editor ) {
			...
			image.editables.author.pathName = lang.pathNameCaption;
	...
	function widgetDef( editor ) {
		...
		return {
			...
			editables: {
				caption: {
					selector: 'figcaption.photo_name',
			...
			data: function() {
				...
				if ( !editor.filter.checkFeature( features.author ) )
					this.data.author = '';
